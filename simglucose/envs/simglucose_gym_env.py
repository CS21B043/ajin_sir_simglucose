...
class T1DSimEnv(gym.Env):
    ...
    def __init__(
        self, patient_name=None, custom_scenario=None, reward_fun=None, seed=None,cgm_sensor=None,insulin_pump=None
    ):
        """
    ...
    def _create_env(self):
        ...
        sensor = (CGMSensor.withName(self.SENSOR_HARDWARE, seed=seed2) if self.sensor is  None else self.sensor)
        pump = (InsulinPump.withName(self.INSULIN_PUMP_HARDWARE) if self.pump is None else self.pump) 
